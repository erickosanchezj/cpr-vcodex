(() => {
  ...
  const messages = {
    en: {
      ...
      latestFirmware: "Latest firmware: 1.3.0.16-cpr-vcodex",
    ...
    es: {
      ...
      latestFirmware: "Último firmware: 1.3.0.16-cpr-vcodex",
      homeFlash: "Auto Flash",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a CPR-vCodex. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.3.0.16-cpr-vcodex", homeStats: "Editor d'estadístiques",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour CPR-vCodex. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.3.0.16-cpr-vcodex", homeStats: "Éditeur de statistiques",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für CPR-vCodex. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.3.0.16-cpr-vcodex", homeStats: "Statistik-Editor",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per CPR-vCodex. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.3.0.16-cpr-vcodex", homeStats: "Editor statistiche",
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para CPR-vCodex. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.3.0.16-cpr-vcodex", homeStats: "Editor de estatísticas",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor CPR-vCodex. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.3.0.16-cpr-vcodex", homeStats: "Statistiekeditor",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для CPR-vCodex. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.3.0.16-cpr-vcodex", homeStats: "Рэдактар статыстыкі",
    ...
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "CPR-vCodex үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.3.0.16-cpr-vcodex", homeStats: "Статистика редакторы",
    ...
    si: {
      navHome: "Domov", navStats: "Urejevalnik statistik", darkMode: "Temni način", lightMode: "Svetli način", homeSubtitle: "Majhna brskalniška orodja za CPR-vCodex. Vse teče lokalno v brskalniku.", latestFirmware: "Najnovejši firmware: 1.3.0.16-cpr-vcodex", homeStats: "Urejevalnik statistik",
  ...
  Object.assign(messages, {
    hu: {
      navHome: "Kezdőlap", navStats: "Statisztika szerkesztő", darkMode: "Sötét mód", lightMode: "Világos mód", homeSubtitle: "Kis böngészős eszközök a CPR-vCodexhez. Minden helyben fut a böngésződben.", latestFirmware: "Legújabb firmware: 1.3.0.16-cpr-vcodex", homeStats: "Statisztika szerkesztő",
    ...
    lt: {
      navHome: "Pradžia", navStats: "Statistikos redaktorius", darkMode: "Tamsus režimas", lightMode: "Šviesus režimas", homeSubtitle: "Maži naršyklės įrankiai CPR-vCodex. Viskas veikia lokaliai jūsų naršyklėje.", latestFirmware: "Naujausia programinė įranga: 1.3.0.16-cpr-vcodex", homeStats: "Statistikos redaktorius",
    ...
    ro: {
      navHome: "Acasă", navStats: "Editor statistici", darkMode: "Mod întunecat", lightMode: "Mod luminos", homeSubtitle: "Mici unelte de browser pentru CPR-vCodex. Totul rulează local în browser.", latestFirmware: "Cel mai nou firmware: 1.3.0.16-cpr-vcodex", homeStats: "Editor statistici",
    ...
    sv: {
      navHome: "Hem", navStats: "Statistikredigerare", darkMode: "Mörkt läge", lightMode: "Ljust läge", homeSubtitle: "Små webbläsarverktyg för CPR-vCodex. Allt körs lokalt i din webbläsare.", latestFirmware: "Senaste firmware: 1.3.0.16-cpr-vcodex", homeStats: "Statistikredigerare",
    ...
    tr: {
      navHome: "Ana sayfa", navStats: "İstatistik düzenleyici", darkMode: "Karanlık mod", lightMode: "Aydınlık mod", homeSubtitle: "CPR-vCodex için küçük tarayıcı araçları. Her şey tarayıcınızda yerel çalışır.", latestFirmware: "En son firmware: 1.3.0.16-cpr-vcodex", homeStats: "İstatistik düzenleyici",
    ...
    uk: {
      navHome: "Головна", navStats: "Редактор статистики", darkMode: "Темний режим", lightMode: "Світлий режим", homeSubtitle: "Невеликі браузерні інструменти для CPR-vCodex. Усе працює локально у браузері.", latestFirmware: "Остання прошивка: 1.3.0.16-cpr-vcodex", homeStats: "Редактор статистики",
    ...
    vi: {
      navHome: "Trang chủ", navStats: "Trình sửa thống kê", darkMode: "Chế độ tối", lightMode: "Chế độ sáng", homeSubtitle: "Các công cụ trình duyệt nhỏ cho CPR-vCodex. Mọi thứ chạy cục bộ trong trình duyệt của bạn.", latestFirmware: "Firmware mới nhất: 1.3.0.16-cpr-vcodex", homeStats: "Trình sửa thống kê",
  ...
  Object.assign(messages, {
    cs: {
      navHome: "Domů", navStats: "Editor statistik", darkMode: "Tmavý režim", lightMode: "Světlý režim", homeSubtitle: "Malé nástroje v prohlížeči pro CPR-vCodex. Vše běží lokálně ve vašem prohlížeči.", latestFirmware: "Nejnovější firmware: 1.3.0.16-cpr-vcodex", homeStats: "Editor statistik",
    ...
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til CPR-vCodex. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.3.0.16-cpr-vcodex", homeStats: "Statistikeditor",
      ...
      navHome: "Etusivu", navStats: "Tilastoeditori", darkMode: "Tumma tila", lightMode: "Vaalea tila", homeSubtitle: "Pieniä selaintyökaluja CPR-vCodexille. Kaikki toimii paikallisesti selaimessasi.", latestFirmware: "Uusin firmware: 1.3.0.16-cpr-vcodex", homeStats: "Tilastoeditori",
    ...
    pl: {
      navHome: "Start", navStats: "Edytor statystyk", darkMode: "Tryb ciemny", lightMode: "Tryb jasny", homeSubtitle: "Małe narzędzia przeglądarkowe dla CPR-vCodex. Wszystko działa lokalnie w przeglądarce.", latestFirmware: "Najnowszy firmware: 1.3.0.16-cpr-vcodex", homeStats: "Edytor statystyk",
    ...
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для CPR-vCodex. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.3.0.16-cpr-vcodex", homeStats: "Редактор статистики",
