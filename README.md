...
- base firmware line: `CrossPoint Reader 1.3.0`
- current release build style: `1.3.0.16-cpr-vcodex`
...
```powershell
python scripts/pre_release_check.py --tag 1.3.0.16-cpr-vcodex
```

- push a stable tag named like `1.3.0.16-cpr-vcodex`
