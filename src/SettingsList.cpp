...
const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_HOME_CAROUSEL, &CrossPointSettings::homeCarouselSource,
                        {StrId::STR_RECENTS, StrId::STR_FAVORITES}, "homeCarouselSource", StrId::STR_CAT_DISPLAY),
      ...
      SettingInfo::Enum(StrId::STR_STUDY_MODE, &CrossPointSettings::flashcardStudyMode,
                        {StrId::STR_DUE, StrId::STR_SCHEDULED, StrId::STR_RANDOM_PRACTICE}, "flashcardStudyMode",
                        StrId::STR_APPS),
      ...
      SettingInfo::Enum(StrId::STR_IF_FOUND_RETURN_ME, &CrossPointSettings::ifFoundShortcut,
                        {StrId::STR_HOME_LOCATION, StrId::STR_APPS}, "ifFoundShortcut",
                        StrId::STR_SHORTCUTS_SECTION),
      SettingInfo::Enum(StrId::STR_README, &CrossPointSettings::readMeShortcut,
                        {StrId::STR_HOME_LOCATION, StrId::STR_APPS}, "readMeShortcut",
                        StrId::STR_SHORTCUTS_SECTION),
